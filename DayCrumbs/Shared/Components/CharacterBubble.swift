...
struct CharacterBubble: View {
    ...
    @ScaledMetric(relativeTo: .title2) private var preferredTextSize: CGFloat = 30
    ...
    var body: some View {
        GeometryReader { proxy in
            ...
            let layoutTextSize = min(34, max(18, bubbleWidth * 0.047))
            let textScale = preferredTextSize / 30
            let responsiveTextSize = min(
                34,
                max(18, layoutTextSize * textScale)
            )
                ...
                Image("BubbleAsset")
                    ...
                    .overlay {
                        Text(text)
                            ...
                            .minimumScaleFactor(18 / responsiveTextSize)
                            .frame(
