...
nonisolated public enum Backend: Equatable {
  /// CPU LiteRT backend.
...
nonisolated public struct EngineConfig {
...
nonisolated public struct SamplerConfig {
...
nonisolated public struct ConversationConfig {
