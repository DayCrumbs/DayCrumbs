...
nonisolated public enum Role: String {
  case system
  case user
  case model
  case tool
...
/// Example Usage:
/// ```swift
/// let textContent = LiteRTLMContent.text("What's the capital of France?")
/// let imageContent = LiteRTLMContent.imageData(imageData)
/// let audioContent = LiteRTLMContent.audioFile(path: "/path/to/audio.wav")
/// ```
nonisolated public enum LiteRTLMContent {
  /// Text.
  case text(String)
...
/// Represents a message in the conversation with LiteRT-LM content.
///
/// Example Usage:
/// ```swift
...
/// ```
nonisolated public struct Message {
  ...
  /// Creates a `Message` from one or more LiteRT-LM content values.
  /// - Parameter contents: The list of contents for this message.
  public init(of contents: LiteRTLMContent..., role: Role = .user) {
  ...
  /// Creates a `Message` from a list of LiteRT-LM content values.
  /// - Parameter contents: The list of contents for this message.
  public init(
    contents: [LiteRTLMContent],
    role: Role = .user,
...
/// Represents a collection of LiteRT-LM content items in a message.
///
/// Example Usage:
/// ```swift
/// let contents = Contents(contents: [.text("Hello")])
/// ```
nonisolated public struct Contents: RandomAccessCollection {
  public typealias Element = LiteRTLMContent
  public typealias Index = Int

  /// The list of underlying content items.
  public var contents: [LiteRTLMContent]

  public var startIndex: Int { contents.startIndex }
  public var endIndex: Int { contents.endIndex }

  public subscript(position: Int) -> LiteRTLMContent {
    return contents[position]
  }

  /// Creates `Contents` from a list of LiteRT-LM content values.
  public init(contents: [LiteRTLMContent]) {
    self.contents = contents
  }
  ...
  /// Creates `Contents` from one or more LiteRT-LM content values.
  public static func of(_ contents: LiteRTLMContent...) -> Contents {
