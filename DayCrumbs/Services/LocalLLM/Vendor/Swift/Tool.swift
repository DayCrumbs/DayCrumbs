...
nonisolated public protocol ToolParameterValue: Codable {
...
nonisolated protocol ToolParamProtocol {
...
/// ```
@propertyWrapper
nonisolated public struct ToolParam<Value: ToolParameterValue>: Decodable, ToolParamProtocol {
...
nonisolated public protocol Tool: Decodable {
...
extension Tool {
  ...
  nonisolated public func getSchema() -> [String: Any] {
...
extension String {
  ...
  nonisolated func camelToSnakeCase() -> String {
  ...
  nonisolated func cleanPropertyLabel(useSnakeCase: Bool) -> String {
